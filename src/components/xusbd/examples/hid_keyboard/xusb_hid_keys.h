...
// @file xusb_hid_keys.h
// @brief Keyboard usage codes and layout definitions for USB HID.

#ifndef XUSB_HID_KEYS_H
#define XUSB_HID_KEYS_H
...
#define KEY_H 0x0b // Keyboard h and H
    ...
    // 0x9a  Keyboard SysRequest/Attention
